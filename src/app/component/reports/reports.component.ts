  ...
  constructor(
    ...
    fetchEarnings() {
      if (!this.userID) {
        ...
        return (alert('If you refresh the page, you will be logged out. Please, go to logout page and log in again.'));
      }
    ...
    return new Chart("BarChart", {
      ...
      options: {
        scales: {
          x: {
            grid: {
              color: 'black', // Black color for the x-axis grid lines
              lineWidth: 2 // Thickness of the x-axis grid lines
            },
            ticks: {
              color: 'black', // Black color for the x-axis tick labels
              font: {
                weight: 'bold' // Bold font weight for the x-axis tick labels
              }
            }
          },
          y: {
            grid: {
              color: 'black', // Black color for the y-axis grid lines
              lineWidth: 2 // Thickness of the y-axis grid lines
            },
            ticks: {
              color: 'black', // Black color for the y-axis tick labels
              font: {
                weight: 'bold' // Bold font weight for the y-axis tick labels
              }
            }
          }
        }
